...
$data_kategori = GetDataKategori($conn);
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
              <div class="x_title">
                <div class="clearfix"></div>
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">Tambah Kategori</button>
              </div>
              <div class="x_content">
                <div class="row">
                  <div class="col-sm-12">
                            ...
                            <tr>
                              ...
                              <td>
                                <form action="../model/User.php" method="post">
                                  ...
                                  <button style="background-color:red;" type="submit" name="deletekat" class="btn cart_quantity_delete"><i class="fa fa-times"></i></button>
                                  ...
                                  <div class="modal-body">
                                    <div class="x_content">
                                      ...
                                      <form action="../model/user.php" method="post">
                                        ...
                                        <input type="text" name="nama" class="form-control" value="<?php echo $data['nama_kategori'] ?>" required />
                                        <label for="email">Kode Rak :</label>
                                        <input type="text" name="kode" class="form-control" value="<?php echo $data['kode_rak'] ?>" required />
                                        <br />
                                        <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_kategori'] ?>" required />
              ...
              <div class="modal-body">
                <div class="x_content">
                  ...
                  <form action="../model/user.php" method="post">
                    ...
                    <br />
                    <button type="submit" class="btn btn-primary" name="tmbhkategori">Tambah</button>
                  </form>
                  <!-- end form for validations -->
